...
public class DelpParser extends Parser<DefeasibleLogicProgram,Formula> implements DelpParserConstants {
  ...
  final public DefeasibleLogicProgram Theory(FolSignature signature) throws ParseException {DefeasibleLogicProgram delp = new DefeasibleLogicProgram();
    label_1:
    while (true) {
...
{if ("" != null) return delp;}
  ...
  final public void Expression(DefeasibleLogicProgram delp,FolSignature signature) throws ParseException {FolFormula lit;
...
delp.add(new DefeasibleRule(lit,body));
  ...
  final public FolFormula Formula(FolSignature signature) throws ParseException {FolFormula lit;
...
{if ("" != null) return lit;}
  ...
  final public FolFormula Literal(DefeasibleLogicProgram delp,FolSignature signature) throws ParseException {FolAtom atom;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NAME:{
...
{if ("" != null) return atom;}
    ...
    case 12:{
      jj_consume_token(12);
      atom = Atom(delp,signature);
{if ("" != null) return new Negation(atom);}
      break;
      }
    default:
      jj_la1[4] = jj_gen;
  ...
  final public FolAtom Atom(DefeasibleLogicProgram delp,FolSignature signature) throws ParseException {Token p;
...
// only add predicate to signature if parsing DeLP!
        ...
        {if ("" != null) return new FolAtom(predicate,terms);}
    throw new Error("Missing return statement in function");
  }

  final public Term Term(DefeasibleLogicProgram delp,FolSignature signature) throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NAME:{
      t = jj_consume_token(NAME);
if(Character.isUpperCase(t.image.charAt(0)))
                        {if ("" != null) return new Variable(t.image);}
                {if ("" != null) return createConstant(t.image, delp, signature);}
      break;
      }
    case QUOTED:{
...
// get rid of quotes:
        ...
        {if ("" != null) return createConstant(text, delp, signature);}
      break;
      }
    default:
      jj_la1[7] = jj_gen;
